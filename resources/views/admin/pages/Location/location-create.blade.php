...
<div style="max-width:900px; margin:0 auto;">
    <div style="margin-bottom:32px;">
        <h1 style="font-size:24px; font-weight:800; color:#0f172a; letter-spacing:-0.5px;">Add New Terminal Path</h1>
        <p style="color:var(--muted); font-size:14px; margin-top:4px;">Configure a new origin and destination terminal pair</p>
    </div>
    ...
    <div class="admin-form-card">
        <form action="{{route('admin.location.store')}}" method="POST">
            ...
            <div style="display:flex; justify-content:flex-end; gap:12px; margin-top:16px; border-top:1px solid var(--border); padding-top:32px;">
                <a href="{{ route('admin.location') }}" class="btn-outline-admin">Discard</a>
                <button type="submit" class="btn-primary-admin" style="min-width:140px; justify-content:center;">Save Location</button>
            </div>
        </form>
    </div>
</div>
