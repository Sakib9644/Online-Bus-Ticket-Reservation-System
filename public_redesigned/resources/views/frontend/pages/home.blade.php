...
{{-- HERO --}}
<section style="background:var(--ink); color:#fff; padding: 100px 40px 80px; position:relative; overflow:hidden;">
    <div style="position:absolute; inset:0; background: radial-gradient(ellipse 60% 80% at 70% 50%, rgba(255,77,28,0.12) 0%, transparent 70%); pointer-events:none;"></div>
    <div style="position:absolute; top:20px; right:80px; width:300px; height:300px; border-radius:50%; border:1px solid #1e1e1e; opacity:.5;"></div>
    <div style="position:absolute; top:60px; right:120px; width:180px; height:180px; border-radius:50%; border:1px solid #252525; opacity:.6;"></div>
